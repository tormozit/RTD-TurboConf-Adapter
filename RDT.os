...
Процедура РедактироватьТекст()
	...
	КонецПопытки;
	ЗавершитьВызовВнешнегоОкнаАсинх(Истина);
...
Процедура ВосстановитьОкноПриложения(ПодключениеИР)
	...
	ЗавершитьВызовВнешнегоОкнаАсинх(Ложь);
	ПодключениеИР.Visible = Истина;
...
Процедура ЗавершитьВызовВнешнегоОкнаАсинх(Знач ВернутьФокусВОкноВызоваСкрипта = Истина) Экспорт
